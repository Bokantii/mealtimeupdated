...
export const RECOMMENDED_DINNER = [
  new Meal(
    ...
    ["2 cups", "1 cup", "1 crust", "1 cup", "2 tbsp", "2 tbsp"],
    9,
    ["mixing-bowl", "rolling-pin", "oven"],
    [
    ...
    false,
    "Dinner",
    "A flaky pastry crust filled with a creamy chicken and vegetable filling.",
    ["Comfort Food", "Savory", "Classic"],
    {
      calories: 520,
      protein: 28,
      carbs: 42,
  ...
  new Meal(
    ...
    ["500g", "2 cups", "1/4 cup", "1 tsp", "2 cloves", "1 tbsp"],
    8,
    ["wok", "spatula"],
    [
    ...
    false,
    "Dinner",
    "A quick and savory Chinese-inspired dish.",
    ["Quick", "Savory", "Healthy"],
    {
      calories: 380,
      protein: 32,
      carbs: 18,
  ...
  new Meal(
    ...
    ["500g", "2 cups", "1 cup", "1/2 cup", "2 tbsp", "2 cloves"],
    8,
    ...
    true,
    "Dinner",
    "A soft pasta dish with a rich, creamy sauce.",
    ["Rich", "Comfort Food", "Vegetarian"],
    {
      calories: 480,
      protein: 16,
      carbs: 52,
